 ...
 */
public final class TesterParquet {
	...
	System.out.println("Storing parquet file into: " + tmpDir);
	...
	//	schemaEvents.cache();
	schemaEvents.saveAsParquetFile(tmpDir + "/schemaEvents.parquet");
    ...
    {
	//	runOperation("load");
	JavaSchemaRDD parquetFile = sqlContext.parquetFile(tmpDir + "/schemaEvents.parquet");
	parquetFile.registerAsTable("events");
