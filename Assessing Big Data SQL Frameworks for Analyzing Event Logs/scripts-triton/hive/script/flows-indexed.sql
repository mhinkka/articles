...
CREATE TABLE events_with_rank (evt_case STRING, evt_event STRING, evt_timestamp TIMESTAMP, evt_asc_rank INT, evt_desc_rank INT);

CREATE INDEX evt_case_index
  ON TABLE events_with_rank (evt_case) AS 'org.apache.hadoop.hive.ql.index.compact.CompactIndexHandler' WITH DEFERRED REBUILD;
...
ALTER INDEX evt_case_index ON events_with_rank REBUILD;
