...
public final class TesterParquet {
	...
	System.out.println("Storing parquet file into: " + tmpFilePath);
	...
	//	schemaEvents.cache();
	schemaEvents.saveAsParquetFile(tmpFilePath);
    ...
    {
	//	runOperation("load");
	DataFrame parquetFile = sqlContext.parquetFile(tmpFilePath);
	parquetFile.registerTempTable("events");
