...
echo export PRESTO_CONF_DIR=$PRESTO_HOME/etc
export LOCAL_DIR=$localTemp/hive
echo export LOCAL_DIR=$localTemp/hive
export HIVE_USER=$USER
echo export HIVE_USER=$USER
...
hiveTestFile=$OUT_DIR/script/${TEST_PREFIX}$TEST_NAME.sql
